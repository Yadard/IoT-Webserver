...
const char* ssid = "Catia"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "28062014"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
