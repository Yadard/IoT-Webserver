...
/* LCD lib v0.5
* This is a archieve of a working, but messy version of LCD libs
! This version seems to be faster than the new one (v1.0)
TODO: Figure out why v1.0 is slower than this version.
*/
